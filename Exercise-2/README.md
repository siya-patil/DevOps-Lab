...
The following outputs were captured from the completed Exercise-2 run on 18 September 2026. The cluster used the Docker driver with Minikube v1.39.0 and Kubernetes v1.37.0.
